    ...
    return (
      <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-dashed border-neutral-200 dark:border-neutral-800 p-12 text-center">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-brand-600 hover:bg-brand-700 text-white rounded-xl text-sm font-semibold transition-colors"
        >
          Set up store
        </Link>
      </div>
    ...
    <div className="space-y-6">
      ...
      {products.length === 0 ? (
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-dashed border-neutral-200 dark:border-neutral-800 p-16 text-center">
          ...
          <Link
            href="/seller-dashboard/products/new"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-brand-600 hover:bg-brand-700 text-white rounded-xl text-sm font-semibold"
          >
            <Plus className="w-4 h-4" /> Add Product
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {products.map((p) => (
            <Link
              ...
              className="group bg-white dark:bg-zinc-900 rounded-2xl border border-neutral-200/60 dark:border-neutral-800/60 overflow-hidden hover:shadow-lg hover:shadow-brand-100/30 dark:hover:shadow-none hover:border-brand-200 dark:hover:border-brand-800/60 transition-all duration-200"
            >
