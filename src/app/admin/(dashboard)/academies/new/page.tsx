  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Add New Academy</h1>
          <p className="text-sm text-slate-500">Create a new academy in the system.</p>
        </div>
      </div>
