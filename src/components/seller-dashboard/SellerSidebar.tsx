...
export function SellerSidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col sticky top-24 w-56 h-fit">
      ...
      <div className="mt-8 p-4 bg-gradient-to-br from-brand-50 to-fuchsia-50/60 dark:from-brand-900/20 dark:to-fuchsia-900/10 rounded-2xl border border-brand-100/80 dark:border-brand-800/30">
