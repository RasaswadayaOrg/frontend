  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border-b border-neutral-200/60 dark:border-neutral-800/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        {/* Brand */}
        <Link href="/organizer-dashboard" className="flex items-center gap-2.5 flex-shrink-0 group">
          <Image
            src="/logo.png"
            alt="Rasaswadaya"
            width={32}
        ...
        <div className="flex items-center gap-1.5">
          ...
          >
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-brand-400 to-brand-600 p-[2px] shadow-sm">
